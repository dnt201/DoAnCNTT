    ...
    uploadTask.on(
      ...
      () => {
        getDownloadURL(uploadTask.snapshot.ref).then((url) => {
          let images = url;
          if (type === "addCategory")
            dispatch(createCategory(nameCategory, parent, images));
    ...
    <div className="add-category-container">
      <div className="add-category-wrap">
        ...
        {success && success === true && (
          <h4 className="t-a-center m-b-16px cl-red">
            <i>Thêm thành công!</i>
          </h4>
        )}
        ...
        <form onSubmit={(e) => handleAdd(e)}>
          ...
          <button className="m-t-8px w-100p btn-add" type="submit">
            Add
          </button>
        </form>
      </div>
