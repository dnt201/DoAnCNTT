...
import { faBars, faTimes, faCaretDown, faCaretRight, faUser,faShoppingCart} from '@fortawesome/free-solid-svg-icons'
            ...
            <nav className={renderNav()}>
                ...
                <ul className="nav-list">
                    ...
                    <div className="move-right">
                        <>
                        {userLogin.userInfo && userLogin.userInfo.role ==="admin" ? null : <li className="cover-size btn user">
                        ...
                        {userLogin.userInfo && userLogin.userInfo.role ==="admin" && <li className="cover-size btn admin">
