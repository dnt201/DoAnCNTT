...
export const productListBrandReducer = (state = { brands: [] }, action) => {
  switch (action.type) {
...
export const productDetailsReducer = (
  ...
  switch (action.type) {
    ...
    case PRODUCT_DETAILS_SUCCESS:
      return { loading: false, product: action.payload.product, data: action.payload.data}
...
export const productCreateReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case PRODUCT_CREATE_SUCCESS:
      return { loading: false,product:action.payload.product, success: true}
