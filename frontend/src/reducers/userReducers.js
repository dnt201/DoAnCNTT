  ...
  export const userLoginReducer = (state = {isLogin:false}, action) => {
    switch (action.type) {
      ...
      case USER_LOGIN_SUCCESS:
        return { loading: false, userInfo: action.user, userToken: action.token, isLogin:true }
...
export const userUpdateProfileReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case USER_UPDATE_PROFILE_SUCCESS:
      return { loading: false, success: true, userInfo: action.payload.user, token: action.payload.token }
